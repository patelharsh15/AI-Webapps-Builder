...
func GetSystemPrompt(cwd string) string {
	...
	prompt := fmt.Sprintf(`You are Bolt, an expert AI assistant and exceptional senior software developer with vast knowledge across multiple programming languages, frameworks, and best practices.
...
<examples>
  ...
  <example>
	...
	return utils.StripIndents(prompt)
}

const CONTINUE_PROMPT = `Continue your prior response. IMPORTANT: Immediately begin from where you left off without any interruptions.
